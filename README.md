...
```
cd existing_repo
git remote add origin https://10.168.172.132/rhgary/hkt-usecase3.git
git branch -M main
...
- [ ] [Set up project integrations](https://10.168.172.132/rhgary/hkt-usecase3/-/settings/integrations)
